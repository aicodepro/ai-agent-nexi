...
def fix_hotword_config():
    ...
    print("  - .env.example: Updated NEXI_HOTWORD_MIN_RMS=0.010, OPENWAKEWORD_SCORE_THRESHOLD=0.35, OPENWAKEWORD_CONSECUTIVE_HITS=2, NEXI_HOTWORD_DEBUG=true")
    ...
    print("\nKey improvements:")
    print("1. Higher NEXI_HOTWORD_MIN_RMS (0.010 vs 0.003) - better noise rejection")
    ...
    print("5. Enabled NEXI_HOTWORD_DEBUG - enhanced troubleshooting")
