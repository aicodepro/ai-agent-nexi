...
from src.orin.control.window_controller import (
...
class TestWindowController(unittest.TestCase):
    @patch("src.orin.control.window_controller.win32gui")
    ...
    @patch("src.orin.control.window_controller._get_visible_windows")
