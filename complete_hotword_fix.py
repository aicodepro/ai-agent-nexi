...
def update_all_config_files():
    ...
    for i, line in enumerate(lines):
        ...
        if line and not line.startswith('#'):
            if 'JARVIS_HOTWORD_MIN_RMS=' in line:
                lines[i] = 'JARVIS_HOTWORD_MIN_RMS=0.010'
                print(f"   ✓ Updated JARVIS_HOTWORD_MIN_RMS to 0.010")
    ...
    verify_path = Path("E:\\jarvis-main\\verify_hotword_final.py")
