...
description: Latency budgets, profiling, concurrency and load-test harnesses.
...
**ID:** S25 | **Class:** studio | **Stage:** implementation | **Risk:** medium

## Responsibility

Latency budgets, profiling, concurrency and load-test harnesses.
