---
name: migration-refactor-engineer
description: Consolidate duplicate routing, state and memory systems behind compatibility layers.
...
# migration-refactor-engineer

**ID:** S27 | **Class:** studio | **Stage:** implementation | **Risk:** medium

## Responsibility

Consolidate duplicate routing, state and memory systems behind compatibility layers.
