...
description: Structured events, traces, metrics, correlation IDs and failure diagnostics.
...
**ID:** S24 | **Class:** studio | **Stage:** implementation | **Risk:** medium

## Responsibility

Structured events, traces, metrics, correlation IDs and failure diagnostics.
