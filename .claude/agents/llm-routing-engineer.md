---
name: llm-routing-engineer
description: Structured routing, capability retrieval, plan validation and model policies.
...
# llm-routing-engineer

**ID:** S19 | **Class:** studio | **Stage:** implementation | **Risk:** medium

## Responsibility

Structured routing, capability retrieval, plan validation and model policies.
