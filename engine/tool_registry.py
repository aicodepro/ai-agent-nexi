...
_TOOLS: dict[str, ToolSpec] = {
    ...
    "crewai_run_router_audit": _spec("crewai_run_router_audit", "Run a background multi-agent audit of the intent router", optional=["input"], handler="engine.integrations.crewai_style.crewai_run_router_audit", aliases=("run an agent audit of the router", "agent audit of the intent router", "run a crew audit", "audit the router with agents", "run router audit workflow"), examples=["run an agent audit of the router"], category="workflow"),
    "crewai_run_codebase_research": _spec("crewai_run_codebase_research", "Run a background multi-agent codebase research workflow", optional=["input"], handler="engine.integrations.crewai_style.crewai_run_codebase_research", aliases=("research this repo with agents", "run codebase research", "research the codebase with agents", "agent research workflow"), examples=["research this repo with agents"], category="workflow"),
    "crewai_run_test_generation": _spec("crewai_run_test_generation", "Run a background multi-agent test-generation workflow", optional=["input"], handler="engine.integrations.crewai_style.crewai_run_test_generation", aliases=("generate tests with agents", "run test generation workflow", "agent test generation"), examples=["generate tests with agents"], category="workflow"),
    "crewai_run_integration_plan": _spec("crewai_run_integration_plan", "Run a background multi-agent integration-plan workflow", optional=["input"], handler="engine.integrations.crewai_style.crewai_run_integration_plan", aliases=("create an integration plan", "run integration plan workflow", "plan the integration with agents"), examples=["create an integration plan"], category="workflow"),
    "crewai_workflow_status": _spec("crewai_workflow_status", "Report the status of the current/last workflow", optional=["run_id"], handler="engine.integrations.crewai_style.crewai_workflow_status", aliases=("workflow status", "show workflow status", "crewai status", "agent workflow status", "whats the workflow status"), examples=["workflow status"], category="workflow"),
    "crewai_workflow_logs": _spec("crewai_workflow_logs", "Show logs of the current/last workflow", optional=["run_id"], handler="engine.integrations.crewai_style.crewai_workflow_logs", aliases=("workflow logs", "show workflow logs", "crewai logs", "agent workflow logs"), examples=["workflow logs"], category="workflow"),
    "crewai_cancel_workflow": _spec("crewai_cancel_workflow", "Cancel the current/last workflow", optional=["run_id"], handler="engine.integrations.crewai_style.crewai_cancel_workflow", aliases=("cancel workflow", "cancel the workflow", "cancel crewai workflow", "cancel agent workflow"), examples=["cancel workflow"], category="workflow"),
...
def _execute_handler(name: str, slots: dict[str, Any], *, confirmed: bool) -> Any:
    ...
    if name.startswith("crewai_"):
        from engine.integrations import crewai_style
        return getattr(crewai_style, name)(slots)
