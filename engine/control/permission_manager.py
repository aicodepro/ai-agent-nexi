...
class PermissionManager:
    ...
    def evaluate(self, action_name, risk_level=None, context=None):
        ...
        if risk_level == "HIGH":
            ...
            if action_name == "screen_capture" and ScreenTrust.is_owner_trusted():
    ...
    def _decision(self, action_name, decision, risk_level=None, requires_confirmation=False,
                  confirmation_prompt="", block_reason="", decision_id="",
                  user_confirmed=False, confirmed_at=None, owner_trusted=False):
        return {
            "action_name": action_name,
            "risk_level": risk_level or _KNOWN_ACTIONS.get(action_name, {}).get("risk_level", "MEDIUM"),
            "decision": decision,
