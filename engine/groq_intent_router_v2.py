...
_SIMPLE_ALIAS_TOOLS = {
    ...
    "crewai_run_router_audit": ("workflow", ("run an agent audit of the router", "run an agent audit of the intent router", "agent audit of the intent router", "run a crew audit", "audit the router with agents", "run router audit workflow")),
    "crewai_run_codebase_research": ("workflow", ("research this repo with agents", "run codebase research", "research the codebase with agents", "agent research workflow")),
    "crewai_run_test_generation": ("workflow", ("generate tests with agents", "run test generation workflow", "agent test generation")),
    "crewai_run_integration_plan": ("workflow", ("create an integration plan", "run integration plan workflow", "plan the integration with agents")),
    "crewai_workflow_status": ("workflow", ("workflow status", "show workflow status", "crewai status", "agent workflow status", "whats the workflow status")),
    "crewai_workflow_logs": ("workflow", ("workflow logs", "show workflow logs", "crewai logs", "agent workflow logs")),
    "crewai_cancel_workflow": ("workflow", ("cancel workflow", "cancel the workflow", "cancel crewai workflow", "cancel agent workflow")),
